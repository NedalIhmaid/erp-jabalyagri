...
class SalesRequestApprovedNotification extends Notification
{
    use Queueable;
    ...
    public function toWhatsApp(object $notifiable): WhatsAppMessage
    {
        return WhatsAppMessage::make(
            ...
            __('whatsapp.sales_request_approved', [
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
            ->subject(__('sales.request_approved'))
            ->greeting(__('general.hello') . ' ' . $notifiable->name . ',')
            ->line(__('sales.request_approved_message'))
    ...
    {
        return [
            'type' => 'sales_request_approved',
            'request_id' => $this->request->id,
            'request_number' => $this->request->request_number,
            'client_name' => $this->request->client_name,
            'message' => __('sales.request_approved_message') . ': ' . $this->request->request_number,
        ];
    }
}
